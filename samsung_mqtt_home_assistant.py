...
def rx_nasa_handler(*nargs, **kwargs):
  ...
  last_nasa_rx = time.time()
  if mqtt_client:
    mqtt_client.publish('homeassistant/binary_sensor/samsung_ehs_communication/state', 'ON', retain=True)
  ...
  while True:
    ...
    try:
      ...
      if args.nasa_timeout > 0 and last_nasa_rx + args.nasa_timeout < time.time():
        ...
        if mqtt_client:
          mqtt_client.publish('homeassistant/binary_sensor/samsung_ehs_communication/state', 'OFF', retain=True)
...
def mqtt_setup():
  ...
  mqtt_create_topic(0x428A, 'homeassistant/number/samsung_ehs_4052_dt_target/config', 'temperature', 'FSV4052 dT Target', 'homeassistant/number/samsung_ehs_4052_dt_target/state', '°C', FSVWriteMQTTHandler, 'homeassistant/number/samsung_ehs_4052_dt_target/set', {"min": 2, "max": 8, "step": 1}, 10) # dt is is 1°C unit, but it handling on a div10 value
  ...
  mqtt_create_topic(0x4260, 'homeassistant/number/samsung_ehs_3021_dhw_max_temp/config', 'temperature', 'FSV3021 DHW Temp w/o Booster', 'homeassistant/number/samsung_ehs_3021_dhw_max_temp/state', '°C', FSVWriteMQTTHandler, 'homeassistant/number/samsung_ehs_3021_dhw_max_temp/set', {"min": 0, "max": 70, "step": 1}, 10)
  mqtt_create_topic(0x4261, 'homeassistant/number/samsung_ehs_3022_dhw_stop_temp/config', 'temperature', 'FSV3022 DHW Stop Temp', 'homeassistant/number/samsung_ehs_3022_dhw_stop_temp/state', '°C', FSVWriteMQTTHandler, 'homeassistant/number/samsung_ehs_3022_dhw_stop_temp/set', {"min": 0, "max": 10, "step": 1}, 10)
  mqtt_create_topic(0x4262, 'homeassistant/number/samsung_ehs_3023_dhw_start_temp/config', 'temperature', 'FSV3023 DHW Start Temp', 'homeassistant/number/samsung_ehs_3023_dhw_start_temp/state', '°C', FSVWriteMQTTHandler, 'homeassistant/number/samsung_ehs_3023_dhw_start_temp/set', {"min": 0, "max": 30, "step": 1}, 10)
  ...
  mqtt_create_topic(0x4286, 'homeassistant/number/samsung_ehs_4042_V3V_dt/config', 'temperature', 'FSV4042 Mixing Valve dT Heating', 'homeassistant/number/samsung_ehs_4042_V3V_dt/state', '°C', FSVWriteMQTTHandler, 'homeassistant/number/samsung_ehs_4042_V3V_dt/set', {"min": 5, "max": 15, "step": 1}, 10)
  mqtt_create_topic(0x4287, 'homeassistant/number/samsung_ehs_4043_V3V_dt/config', 'temperature', 'FSV4043 Mixing Valve dT Cooling', 'homeassistant/number/samsung_ehs_4043_V3V_dt/state', '°C', FSVWriteMQTTHandler, 'homeassistant/number/samsung_ehs_4043_V3V_dt/set', {"min": 5, "max": 15, "step": 1}, 10)
  ...
  mqtt_create_topic(0x42F1, 'homeassistant/number/samsung_ehs_42F1_fr_limit/config', None, '0x42F1 FR limit', 'homeassistant/number/samsung_ehs_42F1_fr_limit/state', None, FSVFreqLimitMQTTHandler, 'homeassistant/number/samsung_ehs_42F1_fr_limit/set', {"min": 0, "max": 150, "step": 10})
